...
export const Nav_ribbon = () => {
    ...
    return (
        <div className="nav_ribbon w-[100px] h-screen bg-[#23272a] py-3">
                <img src={discord_logo} className="ribbon-icon w-[70%] my-1 mx-auto h-auto rounded-2xl hover:shadow-xl"/>
                <img src={new_line} className="ribbon-icon w-[70%] my-3 mx-auto h-auto rounded-2xl hover:shadow-xl" />
                <img src={plus} className="ribbon-icon w-[70%] my-3 bg-[#36393f]  border border-[#36393f] p-4 font-bold mx-auto h-auto rounded-[50%] hover:shadow-xl" />
    ...
    return (
        <div className="navigate absolute top-[0] py-2 w-full  border-b-2 border-[#202225] z-10">
                <div className="w-[50vw] flex justify-around items-center">
                    ...
                    <button className="bg-[#3ba55d] text-white px-2 py-1 rounded-md ">Add Friend</button>
                </div>
        </div>
    )
}
